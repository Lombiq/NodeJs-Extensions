...
> ℹ If you want Solution-wide Markdown analysis it's better to include the [Lombiq.NodeJs.Extensions.SolutionMarkdownAnalysis](../../Lombiq.NodeJs.Extensions.SolutionMarkdownAnalysis/Readme.md) via `<ProjectReference>` or `<PackageReference>`.
